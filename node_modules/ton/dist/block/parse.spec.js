...
describe('parse', () => {
    it('should parse transaction correctly', () => {
        ...
        (0, parse_1.parseTransaction)(address.workChain, cell.beginParse());
    });
    it('should parse tick/tock transactions', () => {
        ...
        const cell = __1.Cell.fromBoc(Buffer.from(tx, 'base64'))[0];
        (0, parse_1.parseTransaction)(-1, cell.beginParse());
    });
    ...
    it('should parse account state with exotic cells', () => {
        ...
        (0, parse_1.parseAccount)(cell.beginParse());
    });
    it('should parse ShardState', () => {
        ...
        const cell = __1.Cell.fromBoc(Buffer.from(state, 'base64'))[0];
        (0, parse_1.parseShardStateUnsplit)(cell.beginParse());
    });
    it('should parse account state with exotic cells', () => {
        let data = require('./__testdata__/configProof');
        const cell = __1.Cell.fromBoc(Buffer.from(data, 'base64'))[0];
        (0, parse_1.parseShardStateUnsplit)(cell.beginParse());
    });
});
