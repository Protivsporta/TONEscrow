...
const WalletV4Source_1 = require("./sources/WalletV4Source");
...
describe('WalletContract', () => {
    ...
    it('should work for v4 contract', async () => {
        let mnemonic = await (0, ton_crypto_1.mnemonicNew)(24);
        let key = await (0, ton_crypto_1.mnemonicToWalletKey)(mnemonic);
        await testSource(key.secretKey, WalletV4Source_1.WalletV4Source.create({ publicKey: key.publicKey, workchain: 0 }));
        await testSource(key.secretKey, WalletV4Source_1.WalletV4Source.create({ publicKey: key.publicKey, workchain: -1 }));
    }, 120000);
});
