...
describe('parseDict', () => {
    it('should parse the one from documentation', () => {
        let root = new Cell_1.Cell()
            .withData('11001000')
            .withReference(new Cell_1.Cell()
            .withData('011000')
            .withReference(new Cell_1.Cell()
        ...
        let res = (0, parseDict_1.parseDictBitString)(root.beginParse(), 16);
    ...
    it('should parse with single node', () => {
        ...
        (0, parseDict_1.parseDictBitString)(root.beginParse(), 256);
    });
    it('should parse dict with exotics', () => {
        ...
        (0, parseDict_1.parseDict)(cs.readRef(), 256, (slice) => {
            return slice.toCell();
        });
    });
});
