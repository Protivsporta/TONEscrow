...
exports.readMessage = exports.readCurrencyCollection = void 0;
function readCurrencyCollection(slice) {
...
exports.readCurrencyCollection = readCurrencyCollection;
function readCommonMsgInfo(slice) {
    if (!slice.readBit()) {
        // Internal
